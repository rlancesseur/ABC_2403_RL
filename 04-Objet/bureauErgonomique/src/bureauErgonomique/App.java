...
public class App {
	...
	public static void main(String[] args) {
		...
		BureauElectrique bureauWafae = new BureauElectrique(70, 200, 150, 100, 64, true, 75, 75, 100);
		BureauElectrique bureauJP = new BureauElectrique(75, 200, 150, 120, 70, true, 70, 73, 110);
